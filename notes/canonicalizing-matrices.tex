...
\begin{theorem}\label{thm:no-Od-canon-for-dxn}
    ...
    \begin{proof}
        ...
        Next, observe that $S^{d(d+1) - 1}/O(d)$ is homeomorphic to $\set{A \in \S^{d+1} : \det(A) = 0}/\Rp$ by corollary \ref{cor:Rnd/Od-cong-Snd}, which is in turn homeomorphic to the boundary of the ball of dimension $(d+1)(d+2)/2 - 1$, i.e. the sphere of that dimension, by proposition \ref{prop:PSD-mod-scale-cong-ball}.
