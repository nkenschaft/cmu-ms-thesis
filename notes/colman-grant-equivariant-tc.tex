\section{Background from \cite{colman2013equivariant}}
...
\begin{proposition}\label{prop:cohomological-lower-bound-for-secat}
...
\begin{definition}
    For $x \in X$ a $G$-space, the \emph{isotropy group} of $x$ is
    \[
        G_x := \set{g \in G : gx = x}.
    \]
\end{definition}
