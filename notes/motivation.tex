...
\]
This of course doesn't make sense if the group $G$ is infinite (like the case of rotational symmetries), but it can be made precise using integration and measure theory; this is explored further in \cite{dym2024equivariant}, \cite{puny2022frameaveraginginvariantequivariant}, \cite{ma2024canonicalizationperspectiveinvariantequivariant}, and chapter \ref{ch:frame-averaging}.

% TODO: discuss equivariant/invariant models + why canonicalization/frames are valuable
\begin{enumerate}
    \item GNNs can't fully distinguish graphs and can be computationally intensive (see references in introduction of \cite{puny2022frameaveraginginvariantequivariant})
\end{enumerate}