...
\begin{definition}
    The \emph{zero-divisors-cup-length} or simply \emph{cup-length} of $H^\bullet (X)$, denoted $\cuplength(X)$ is the length of the longest nontrivial product in the ideal of zero-divisors of $H^\bullet (X)$.
\end{definition}
